...
describe('Invite members from Org Settings', () => {

const selector = {
    userAvatar : '.styles__StyledNewIcon-sc-p8dqpg-1',
    orgSettings : '[data-tooltip-id="app-tooltip"] > .Menu__MenuItemPart-sc-6fjgt9-7',
    sideMenuMembers : '[data-testid="integration-sidebar-Members"]',
    inviteMemButton: '.InviteMemberButton__StyledButtonText-sc-6rxm7f-1.eKiPWl',
  ...
  it('Invite new members to organization', () => {
    // Perform Login
    login(
    ...
    //Check for an existing member in the organization 
    ...
    $btn[0].addEventListener('click', (e) => e.preventDefault());
            ...
            cy.wait(3000)
            //cy.get(selector.cancelBtn).click()
  ...
  cy.get(selector.sendInviteBtn).then(($btn) => {
    ...
    //Check if the invitation is sent 
