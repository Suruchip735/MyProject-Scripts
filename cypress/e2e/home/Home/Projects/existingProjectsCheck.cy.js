...
//        admPortfolio:'.BoardSelectMenu__StyledBody-sc-aholn7-5 > :nth-child(5)',
        projectNameField: '.AddEditProjectForm__ProjectNameContainer-sc-shiuev-0 > .AddEditProjectForm__InputFieldContainer-sc-shiuev-3 > input',
    ...
    it('Check if creating existing projects fail', () => {
      // Perform Login
      login(
    ...
    cy.get('.BoardSelectMenu__StyledBody-sc-aholn7-5')
      ...
      cy.log("You cannot create project with same title and numnber as an existing projects on this board")
    cy.wait(2000)
  })
    });
